...
enum DraftScreen: String, CaseIterable, Identifiable {
    ...
    var title: String {
        switch self {
        case .dataTab: return "Data Tab"
        case .structureTab: return "Structure Tab"
        case .queryTab: return "Query Tab"
        case .erTab: return "ER Tab"
        case .sheetsOverlays: return "Sheets & Overlays"
        case .databaseScreen: return "Database Screen"
        }
    }

    var subtitle: String {
        switch self {
        case .dataTab: return "Grid, breadcrumb, filter, row detail"
        case .structureTab: return "Columns, DDL toolbar, indexes"
        case .queryTab: return "SQL editor, results, status bar"
        case .erTab: return "Diagram nodes, edges, zoom"
        case .sheetsOverlays: return "Row editor, DDL, alerts, popover"
        case .databaseScreen: return "Server list, status, search"
        }
    }

    var symbol: String {
        switch self {
        case .dataTab: return "tablecells"
        case .structureTab: return "list.bullet.rectangle"
        case .queryTab: return "terminal"
        case .erTab: return "point.3.connected.trianglepath.dotted"
        case .sheetsOverlays: return "rectangle.on.rectangle"
        case .databaseScreen: return "server.rack"
        }
    }
}
