...
enum DraftSampleData {
    ...
    static let tables: [DraftTable] = [
        DraftTable(name: "users", isView: false, rowCount: 10_482, columns: usersColumns, rows: usersRows),
        DraftTable(name: "orders", isView: false, rowCount: 48_201, columns: [], rows: []),
        DraftTable(name: "order_items", isView: false, rowCount: 132_940, columns: [], rows: []),
        DraftTable(name: "products", isView: false, rowCount: 3_120, columns: [], rows: []),
