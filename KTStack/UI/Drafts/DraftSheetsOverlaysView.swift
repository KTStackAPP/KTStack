...
struct DraftSheetsOverlaysView: View {
    ...
    private var deleteAlert: some View {
        alert(icon: "trash", iconTint: KTEditorTheme.Status.error, title: "Delete this row?",
              message: "This permanently removes 1 row from users. This action cannot be undone.",
              confirm: "Delete")
    }

    private var destructiveAlert: some View {
        alert(icon: "exclamationmark.triangle.fill", iconTint: KTEditorTheme.Status.warning,
    ...
    private func sheet<Content: View>(title: String, width: CGFloat,
    ...
    private func fieldRow(_ name: String, type: String?, value: String,
                          readOnly: Bool = false, isPK: Bool = false) -> some View {
