...
public struct NginxCatchAllCert {
    ...
    public var certFile: URL { paths.catchAllCert }
    public var keyFile: URL { paths.catchAllKey }
    ...
    public func ensure() throws -> (cert: URL, key: URL) {
        ...
        try FileManager.default.createDirectory(at: paths.caDir, withIntermediateDirectories: true,
        ...
        proc.arguments = [
            ...
            "-days", "3650", "-subj", "/CN=kdwarm-catchall",
        ]
        let err = Pipe()
